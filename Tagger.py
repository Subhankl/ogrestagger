...
async def start(event):
  await event.reply("👋 Salam \n\n💬 Mən sizin qurupunuzda istifadəçiləri çağırmağınız üçün yaradılmış çox funksiyalı botam\n\n✅ Botun istifadə qaydasını öyrənmək üçün\n\n/help əmrindən istifadə edin",
         buttons=(
		      [Button.url('ᴏᴡɴᴇʀ ❤️‍🔥', 'http://t.me/Alpha0wner')],
                      [Button.url('sᴜᴘᴘᴏʀᴛ 🐊', 'https://t.me/Alpha_H0use')],
                      [Button.url('ʀ əｓᴍ ɪ ᴋᴀɴᴀʟ ❤️‍🔥', 'https://t.me/GeceAvcisiMMC')],
                      [Button.url('Mᴇᴋᴀɴɪᴍɪᴢ 🔖', 'https://t.me/Alpha_H0use')],
		      [Button.url('💫 ᴍᴇɴɪ ǫʀᴜᴘᴜɴᴀ ᴇʟᴀᴠᴇ ᴇᴛ', 'https://t.me/LuciTaggerBot?startgroup=a')] 
                    ),
                    link_preview=False
                   )
...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                        [Button.url('✨️ Məni Qurupa əlavə et ✨️', 'http://t.me/LuciTaggerBot?startgroup=a')],
                      [Button.url('Support 🐊', 'https://t.me/Alpha_H0use')],
                      [Button.url('Rəsmi Kanal 🔖', 'https://t.me/GeceAvcisiMMC')],
                      [Button.url('Məkanımız 🔖', 'https://t.me/Alpha_H0use')],
		      [Button.url('Owner ❤️‍🔥', 'https://t.me/Alpha0wner')]
                    ),
                    link_preview=False
                   )
...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('༒︎ 𝐀𝐋𝐏𝐇𝐀 𝐇𝐎𝐔𝐒𝐄 💬 𓆙 ', 'https://t.me/Alpha_H0use')],
                    ),
                    link_preview=False
                   )
